class User < ApplicationRecord
  ...
  def User.digest(string) # LLAMADA ORIGINAL antes de 9.4
  ...
  def User.new_token # LLAMADA Antes de 9.5
  ...
  def feed
    ...
    #Micropost.where("user_id IN (?) OR user_id = ?", following_ids, id) ### 14.44
    #Micropost.where("user_id IN (?)", following_ids) ### Ejercicio 1, 14.3.2
    #Micropost.where("user_id = ?", id) ### Ejercicio 2, 14.3.2
    #Micropost.all ### Ejercicio 3, 14.3.2
    #Micropost.where("user_id IN (:following_ids) OR user_id = :user_id",
    #                following_ids: following_ids, user_id: id) ### 14.46
